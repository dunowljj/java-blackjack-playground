...
public class AbstractParticipantTest {
    ...
    void 이름_입력() {
        ...
        //when
        AbstractParticipant participant = new Player(name, new Cards()); //todo: 생성자를 어떻게 정리할것인가?
    ...
    void 배팅금액_입력() {
        ...
        AbstractParticipant participant = new Player(inputName, inputBetMoney, new PlayingCards());
